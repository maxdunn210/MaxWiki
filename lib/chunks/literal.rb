...
module Literal
 ...
 # A literal chunk that protects Ruby erb tags from wiki rendering.
  class Erb < AbstractLiteral
    ERB_PATTERN = Regexp.new('<%.*?%>', Regexp::MULTILINE) 
    def self.pattern() ERB_PATTERN  end
  end
